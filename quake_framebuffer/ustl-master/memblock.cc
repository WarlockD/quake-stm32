...
extern void* umm_realloc(void* old, size_t size);
extern void* umm_malloc(size_t size);

#define FREE(P) umm_free((P))
#define REALLOC(O,S) umm_realloc((O),(S))
#define MALLOC(S) umm_malloc((S))
namespace qstl {
