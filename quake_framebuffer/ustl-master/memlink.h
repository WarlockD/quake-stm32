...
public:
   ...
   inline const_pointer	data (void) const			{ return cmemlink::data(); }
    ...
    inline void		link (const void* first, const void* last)	{ link (first, std::distance (static_cast<const char*>(first), static_cast<const char*>(last))); }
    inline void		link (void* first, void* last)		{ link (first, std::distance (static_cast<const char*>(first), static_cast<const char*>(last))); }
