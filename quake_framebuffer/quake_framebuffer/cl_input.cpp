...
cvar_t<float> cl_upspeed = { 200.0f} ;
cvar_t<float> cl_forwardspeed = { 200.0f, true} ;
cvar_t<float> cl_backspeed = { 200.0f, true} ;
cvar_t<float> cl_sidespeed = { 350.0f} ;

cvar_t<float> cl_movespeedkey = { 2.0f} ;

cvar_t<float> cl_yawspeed = { 140.0f} ;
cvar_t<float> cl_pitchspeed = { 150.0f} ;

cvar_t<float> cl_anglespeedkey = { 1.5f} ;
