...
void D_Sky_uv_To_st (int u, int v, fixed16_t *s, fixed16_t *t)
{
	...
	temp = idCast<float>(skytime)*skyspeed;	// TODO: add D_SetupFrame & set this there
...
void D_DrawSkyScans8 (espan_t *pspan)
{
	...
	// calculate the initial s & t
		...
		do
		{
			...
			// Intresting, windows throws an exception here when snext isn't initilized
			// however, this is when count is == 0 so it odns't matter at this point
			s = snext;
			t = tnext;
