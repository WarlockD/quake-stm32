...
template <> inline size_t stream_align_of(const _long4grain&) { return 4; } }
...
//template <> inline size_t stream_align_of(const ustl::CBacktrace&) { return sizeof(void*); }
//----------------------------------------------------------------------
//template <> inline size_t stream_align_of<_long4grain>(const _long4grain) { return grain; } }
} // namespace ustl
