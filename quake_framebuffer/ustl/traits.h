...
#undef TMTT1
		public:
			...
			enum {
				isStdUnsignedInt = tl::IndexOf<StdUnsignedInts, UnqualifiedType>::value >= 0 ||
				tl::IndexOf<StdUnsignedInts,
				typename ReferenceTraits<UnqualifiedType>::ReferredType>::value >= 0
			};
			enum {
				isStdSignedInt = tl::IndexOf<StdSignedInts, UnqualifiedType>::value >= 0 ||
			...
			enum {
				isStdFloat = tl::IndexOf<StdFloats, UnqualifiedType>::value >= 0 ||
