...
namespace ustl {
	...
	public:
		...
		inline void			assign(const cmemlink_t<LINK, TOP, char>& l) { assign(l.data(), l.readable_size()); }
		template<typename LINK, typename TOP>
		inline const memblock&	operator= (const cmemlink_t<LINK, TOP, char>& l) { assign(l); return *this; }
