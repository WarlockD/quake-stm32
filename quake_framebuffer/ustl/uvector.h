...
namespace ustl {
	...
	///
	template <typename T, typename C = memblock>
	class vector {
	public:
		using container = C;
	...
	private:
		container			_data;	///< Raw element data, consecutively stored.
	};

	/// Allocates space for at least \p n elements.
	template <typename T, typename C>
	inline void vector<T, C>::reserve(size_type n, bool bExact)
	{
		_data.reserve(n * sizeof(T), bExact);
	}

	template <typename T, typename C>
	inline typename vector<T, C>::iterator vector<T, C>::append_hole(size_type n)
	{
	...
	template <typename T, typename C>
	inline void vector<T, C>::resize(size_type n, bool bExact)
	{
		destroy(begin() + n, end());
	...
	template <typename T, typename C>
	inline void vector<T, C>::deallocate(void) noexcept
	{
		destroy(begin(), end());
		_data.deallocate();
	}
	...
	template <typename T, typename C>
	inline vector<T, C>::vector(size_type n)
		:_data()
	{
		resize(n);
	}
	...
	template <typename T, typename C>
	vector<T, C>::vector(size_type n, const T& v)
		:_data()
	{
	...
	/// Copies \p v.
	template <typename T, typename C>
	vector<T, C>::vector(const vector<T,C>& v)
		:_data()
	{
	...
	template <typename T, typename C>
	vector<T, C>::vector(const_iterator i1, const_iterator i2)
		:_data()
	{
	...
	/// Destructor
	template <typename T, typename C>
	inline vector<T, C>::~vector(void) noexcept
	{
		destroy(begin(), end());
	}
	...
	template <typename T, typename C>
	inline void vector<T, C>::assign(const_iterator i1, const_iterator i2)
	{
		assert(i1 <= i2);
	...
	template <typename T, typename C>
	inline void vector<T, C>::assign(size_type n, const T& v)
	{
		resize(n);
	...
	template <typename T, typename C>
	inline const vector<T, C>& vector<T, C>::operator= (const vector<T,C>& v)
	{
	...
	template <typename T, typename C>
	inline typename vector<T, C>::iterator vector<T, C>::insert_hole(const_iterator ip, size_type n)
	{
	...
	/// Inserts \p n uninitialized elements at \p ip.
	template <typename T, typename C>
	inline typename vector<T, C>::iterator vector<T, C>::insert_space(const_iterator ip, size_type n)
	{
	...
	template <typename T, typename C>
	inline typename vector<T, C>::iterator vector<T, C>::insert(const_iterator ip, size_type n, const T& v)
	{
	...
	template <typename T, typename C>
	inline typename vector<T, C>::iterator vector<T, C>::insert(const_iterator ip, const T& v)
	{
	...
	template <typename T, typename C>
	inline typename vector<T, C>::iterator vector<T, C>::insert(const_iterator ip, const_iterator i1, const_iterator i2)
	{
		assert(i1 <= i2);
	...
	template <typename T, typename C>
	inline typename vector<T, C>::iterator vector<T, C>::erase(const_iterator ep, size_type n)
	{
	...
	template <typename T, typename C>
	inline typename vector<T, C>::iterator vector<T, C>::erase(const_iterator ep1, const_iterator ep2)
	{
		assert(ep1 <= ep2);
	...
	template <typename T, typename C>
	inline void vector<T, C>::push_back(const T& v)
	{
	...
	template <typename T, typename C>
	template <typename... Args>
	inline typename vector<T, C>::iterator vector<T, C>::emplace(const_iterator ip, Args&&... args)
	{
	...
	template <typename T, typename C>
	template <typename... Args>
	inline void vector<T, C>::emplace_back(Args&&... args)
	{
