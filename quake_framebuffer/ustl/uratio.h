...
template <typename R1, typename R2>
struct ratio_equal : public std::integral_constant<bool,
    R1::num == R2::num && R1::den == R2::den> {};

template <typename R1, typename R2>
struct ratio_not_equal : public std::integral_constant<bool,
    !ratio_equal<R1,R2>::value> {};

template <typename R1, typename R2>
struct ratio_less : public std::integral_constant<bool,
    ratio_subtract<R1,R2>::num < 0> {};

template <typename R1, typename R2>
struct ratio_less_equal : public std::integral_constant<bool,
    ratio_subtract<R1,R2>::num <= 0> {};

template <typename R1, typename R2>
struct ratio_greater : public std::integral_constant<bool,
    !ratio_less_equal<R1,R2>::value> {};

template <typename R1, typename R2>
struct ratio_greater_equal : public std::integral_constant<bool,
