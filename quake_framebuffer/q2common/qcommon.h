...
#ifndef _QUAKE2_QCOMMON_H_
#define _QUAKE2_QCOMMON_H_
...
char *CopyString (const char *in,bool make_lower=false);
...
typedef void(*rd_flush_func)(int, char*);
void		Com_BeginRedirect(int target, char *buffer, int buffersize, rd_flush_func flush);
